...
class PayrollPayGroup(Base):
    ...
    working_pattern = Column(String(40), default="company")  # company, 5_day, 6_day, rotational_weekly_off, shift_roster
    working_days_per_week = Column(Integer)
    weekly_off_weekdays = Column(JSON)  # Monday=0 ... Sunday=6
...
class EmployeeSalary(Base):
    ...
    payroll_type = Column(String(40), default="monthly_fixed", index=True)
    wage_rate = Column(Numeric(12, 2), default=0)
    default_units = Column(Numeric(12, 2), default=0)
    unit_label = Column(String(40))
    commission_rate_percent = Column(Numeric(8, 4), default=0)
    commission_base_amount = Column(Numeric(14, 2), default=0)
    invoice_amount = Column(Numeric(14, 2), default=0)
    effective_from = Column(Date, nullable=False)
...
class PayrollRun(Base):
    ...
    pay_group_id = Column(Integer, ForeignKey("payroll_pay_groups.id", ondelete="SET NULL"), nullable=True, index=True)
    employee_category = Column(String(80), index=True)
