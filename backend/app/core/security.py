...
def create_access_token(subject: Union[str, Any], expires_delta: Optional[timedelta] = None, session_id: int | None = None) -> str:
...
def create_refresh_token(subject: Union[str, Any], session_id: int | None = None) -> str:
