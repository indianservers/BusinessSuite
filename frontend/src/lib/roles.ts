...
const crmNav: RoleNavItem[] = [
  { label: "Dashboard", icon: LayoutDashboard, to: "/crm", group: "Core", exact: true },
  { label: "AI Agents", icon: Sparkles, to: "/ai-agents/config", group: "Core" },
  { label: "Leads", icon: Users, to: "/crm/leads", group: "Core" },
  { label: "Contacts", icon: UserRound, to: "/crm/contacts", group: "Core" },
  { label: "Companies", icon: Building2, to: "/crm/companies", group: "Core" },
  ...
  { label: "Auto Responses", icon: Send, to: "/crm/auto-responses", group: "Growth" },
  { label: "Delivery Logs", icon: ScrollText, to: "/crm/delivery-logs", group: "Growth" },
  { label: "Communication Timeline", icon: TableProperties, to: "/crm/communication-timeline", group: "Growth" },
  ...
  { label: "Customer 360", icon: Users, to: "/crm/customer-360", group: "Support" },
  ...
  { label: "CRM Admin", icon: ShieldCheck, to: "/crm/admin", group: "Admin" },
];
...
const projectManagementNav: RoleNavItem[] = [
  ...
  { label: "Risk Register", icon: ShieldAlert, to: "/pms/risk-register", group: "Project Management", badge: "RAID" },
  ...
  { label: "Live Work", icon: Gauge, to: "/pms/live", group: "Project Management", badge: "Realtime" },
  ...
  { label: "Issues", icon: AlertTriangle, to: "/pms/issues", group: "Project Management" },
  { label: "Tasks", icon: ListChecks, to: "/pms/tasks", group: "Project Management" },
  { label: "Issue Navigator", icon: Search, to: "/pms/navigator", group: "Project Management" },
  { label: "Issue Navigator Pro", icon: FileSearch, to: "/pms/issue-navigator-pro", group: "Project Management" },
  { label: "Dashboards", icon: BarChart3, to: "/pms/dashboards", group: "Project Management" },
  { label: "Projects", icon: Briefcase, to: "/pms/projects", group: "Project Management" },
  { label: "Kanban", icon: LayoutGrid, to: "/pms/projects", group: "Project Management" },
  { label: "Goals", icon: Trophy, to: "/pms/goals", group: "Project Planning" },
  ...
  { label: "Plans", icon: FileCheck2, to: "/pms/plans", group: "Project Planning", badge: "Scale" },
  ...
  { label: "Templates", icon: BookOpen, to: "/pms/templates", group: "Project Planning" },
  { label: "Calendar", icon: CalendarDays, to: "/pms/calendar", group: "Project Planning" },
  { label: "Gantt", icon: GitMerge, to: "/pms/gantt", group: "Project Planning" },
  ...
  { label: "Blueprints", icon: Workflow, to: "/pms/blueprints", group: "Project Admin" },
...
const srmNav: RoleNavItem[] = [
  ...
  { label: "POS Returns", icon: RotateCcw, to: "/srm/pos/returns", group: "Sales & Inventory" },
