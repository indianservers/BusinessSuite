...
export type FrontendAppKey = "hrms" | "crm" | "project_management" | "srm";
...
const rawInstalledApps = import.meta.env.VITE_INSTALLED_APPS || "hrms,crm,project_management,srm";
const validAppKeys: FrontendAppKey[] = ["hrms", "crm", "project_management", "srm"];
